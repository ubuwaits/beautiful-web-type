---
layout: default
title: Beautiful web type &mdash; the best typefaces from the Google web fonts directory
keyword: index
---
...
<section class="samples">
  <section class="sample" id="title">
    <section class="text">
      ...
      <h2>A showcase of the best typefaces from the <a href="https://www.google.com/fonts#ChoosePlace:select">Google web fonts directory</a>.</h2>
      ...
      <section class="intro">
        ...
        <ul>
          <li><a href="http://chad.is">Maintained by Chad Mazzola</a></li>
  ...
  <section class="sample" id="herzog">
    <section class="text">
        <a href="https://www.google.com/fonts/specimen/Cardo" title="Cardo">
  ...
  <section class="sample" id="bringhurst">
    <section class="text">
      <a href="https://www.google.com/fonts/specimen/Vollkorn" title="Vollkorn">
        <h1>&ldquo;Big type, even huge type, can be beautiful and useful.<br> But poise is usually far more important than size &mdash;<br> and poise consists primarily of emptiness.&rdquo;</h1>
  ...
  <section class="sample" id="nietzsche">
    <section class="text">
      <a href="https://www.google.com/fonts/specimen/Open+Sans" title="Open Sans">
      ...
      <section class="excerpt">
        <a href="https://www.google.com/fonts/specimen/Gentium+Book+Basic" title="Gentium Book Basic">
  ...
  <section class="sample" id="tufte">
    <section class="text">
      <a href="https://www.google.com/fonts/specimen/Vollkorn" title="Vollkorn">
        ...
        <p><span>&ldquo;</span>The best graphics are about the useful and important, about life and death, about the universe. Beautiful graphics do not traffic with the trivial.<span>&rdquo;</span></p>
      </a>
    </section>
  </section>
  ...
  <section class="sample" id="seneca">
    <section class="text">
        <div class="body">
          <a href="https://www.google.com/fonts/specimen/Lato" title="Lato">
            <p class="title">Lucius Annaeus Seneca<br>60 AD</p>
          </a>
          <a href="https://www.google.com/fonts/specimen/Merriweather" title="Merriweather">
            <h1>De Beneficiis</h1>
            <hr>
            <h2>Book I.</h2>
  ...
  <section class="sample" id="nabokov">
    <section class="text">
      <a href="https://www.google.com/fonts/specimen/Playfair+Display" title="Playfair Display">
  ...
  <section class="sample" id="postnormal">
    <section class="text">
      <a href="https://www.google.com/fonts/specimen/Oswald" title="Oswald">
        <h2>Post&mdash;&mdash;</h2>
        <h2>Normal</h2>
        <h2>Era</h2>
      </a>

      <a href="https://www.google.com/fonts/specimen/PT+Mono" title="PT Mono">
        <ol class="normal">
  ...
  <section class="sample" id="slogan">
    <section class="text">
      <a href="https://www.google.com/fonts/specimen/Gravitas+One" title="Gravitas One">
        <h1>Don&rsquo;t die</h1>
        <h1>wondering</h1>
      </a>
    </section>
  </section>
  ...
  <section class="sample" id="darwin">
    <section class="text">
      <a href="https://www.google.com/fonts/specimen/Old+Standard+TT" title="Old Standard TT">
        ...
        <h3>Fellow of the Royal, Geological, Linn&aelig;an, ETC., Societies;<br>Author of &lsquo;Journal of Researches During H.M.S. Beagle&rsquo;s Voyage Round the World.&rsquo;</h3>
  ...
  <section class="sample" id="headline">
    <section class="text">
      <a href="https://www.google.com/fonts/specimen/Abril+Fatface" title="Abril Fatface">
  ...
  <section class="sample" id="camus">
    <section class="text">
      <a href="https://www.google.com/fonts/specimen/PT+Sans+Narrow" title="PT Sans Narrow">
        <h1>Albert Camus Buried</h1>
      </a>
        <hr>
      <a href="https://www.google.com/fonts/specimen/PT+Sans" title="PT Sans">
        <h2>Simple Ceremony Is Held for French Nobel Prize Author</h2>
      </a>
        <hr class="bottom">
      <a href="https://www.google.com/fonts/specimen/PT+Serif" title="PT Serif">
        <p>PARIS, Jan. 6&mdash;Albert Camus, one of France&rsquo;s ranking writers and winner of a
